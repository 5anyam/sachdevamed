...
export const PRODUCTS: StaticProduct[] = [
  {
    ...
    shortName: 'Oxygen Concentrator JAY-5',
    tagline: '5 LPM medical-grade oxygen concentrator — reliable, quiet & 24/7 capable',
    price: 24900,
    regularPrice: 24900,
    images: [
      '/products/jay-5/01.jpg',
      '/products/jay-5/02.jpg',
    ],
    benefits: [
  ...
  },
  {
    ...
    shortName: 'Oxygen Concentrator JAY-5AW',
  ...
  },
  {
    ...
    benefits: [
      ...
      'CDSCO approved for India — authorised by Sachdeva Medline with a 2 years full warranty',
  ...
  },
  {
    ...
    shortName: 'Oxygen Concentrator JAY-5CW',
  ...
  },
  {
    ...
    shortName: 'Oxygen Concentrator JAY-5HW',
