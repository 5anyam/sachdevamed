...
export const CONCENTRATORS: ConcentratorProduct[] = [
  /* ─────────────────────────── JAY-5CW ─────────────────────────── */
  {
    ...
    subtitle: '5 Litre Medical Oxygen Concentrator',
    ...
    notes: [
      ...
      '*CDSCO Licence IMP/MD/2025/000509 — CE and ISO certified',
    ],
    ...
    seoDescription:
      'Buy the Longfian JAY-5CW 5 litre medical oxygen concentrator in India. Above 93% oxygen purity, nebulizer outlet, full lithium sieve beds, only 16 kg, under 43 dB, 350W. CDSCO registered, CE and ISO certified. Exclusive importer Sachdeva Medline — free pan-India delivery.',
    keywords: [
      'Longfian JAY-5CW',
  ...
  /* ─────────────────────────── JAY-5HW ─────────────────────────── */
  {
    ...
    subtitle: '5 Litre Oxygen Concentrator with HEPA Filter & Nebuliser',
    price: 0, // TODO: selling price in ₹
    mrp: 0, // TODO: MRP in ₹
    ...
    highlights: [
      { icon: '💨', title: '0 – 5 L/min Flow', sub: '93% ± 3% purity at all flow rates' },
    ...
    notes: [
      '*Displays live oxygen concentration, flow rate and running hours',
      '*Whisper-quiet at ≤ 38 dB(A) — among the quietest 5 L units available',
      '*Alarms for low purity, high/low pressure, power failure, overheat and system failure',
      '*Advanced PSA technology for stable output and lower power consumption',
      '*CE · CDSCO · FDA · ISO certified',
    ],
    ...
    stats: [
      ...
      { val: '≤38 dB', lbl: 'Noise Level', sub: 'Quieter than a library' },
    ],
    benefits: [
      ...
      { icon: '🛡️', title: '2-Year Warranty', text: '2 years or 8,000 working hours, whichever is earlier — supported by 15+ service centres across India.' },
    ],
    specs: [
      {
        group: 'Performance',
    ...
    seoDescription:
      'Buy the Longfian JAY-5HW 5 litre oxygen concentrator in India. 93%±3% purity shown live on the display, inbuilt HEPA filter and nebuliser, ≤38 dB, 16 kg, 350W. CE, CDSCO, FDA and ISO certified. 2-year warranty from Sachdeva Medline with free pan-India delivery.',
    keywords: [
      'Longfian JAY-5HW',
  ...
  /* ─────────────────────────── JAY-5AW ─────────────────────────── */
  {
    ...
    highlights: [
      { icon: '💨', title: '0 – 5 Litre Flow', sub: 'Above 93% oxygen concentration always' },
      { icon: '🔇', title: 'Under 40 dB(A)', sub: 'Oil-free compressor — no disturbance at night' },
      { icon: '🌬️', title: 'Nebuliser Mask Included', sub: 'Complete home oxygen setup in the box' },
    ],
    notes: [
      '*Flow meter adjusts from 0 to 5 litres as per the patient\'s requirement',
      '*Above 93% oxygen concentration at all times',
      '*Powerful oil-free air compressor running under 40 dB(A)',
    ...
    stats: [
      ...
      { val: '<40 dB', lbl: 'Noise Level', sub: 'Oil-free compressor' },
    ],
    benefits: [
      { icon: '🔇', title: 'No Disturbance At Night', accent: 'Under 40 dB(A)', text: 'A powerful oil-free air compressor keeps the unit under 40 dB — quieter than a library, so it can run beside a bed all night.' },
      ...
      { icon: '🎚️', title: 'Flow Adjustable 0 – 5 L', text: "The flow meter can easily be adjusted from 0 to 5 litres as per the patient's prescribed requirement." },
    ...
    specs: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Mobility', 'Castor wheels + carry handle'],
          ['Design', 'Compact and space-friendly'],
        ],
      },
      {
        group: 'Safety',
    ...
    seoDescription:
      'Buy the Longfian JAY-5AW 5 litre medical grade oxygen concentrator in India. Above 93% oxygen purity, oil-free compressor under 40 dB, flow adjustable 0–5 litres, LCD status display and full safety alarms. CE, ISO, CDSCO and FDA approved. Sachdeva Medline — free pan-India delivery.',
    keywords: [
      'Longfian JAY-5AW',
      'oxygen concentrator 5 litre',
      '5 LPM oxygen concentrator',
